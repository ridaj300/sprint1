...
urlpatterns = [
    ...
    # Dashboard and Sentiment Analysis
    path('Dashboard', views.DASHBOARD, name='dashboard'),
    path('PerformSentimentAnalysis', views.perform_sentiment_analysis, name='perform_sentiment_analysis'),  # Added this line
